...
int main()
{
    ...
    vector<vector<int>> graphtest = {
     {0, 1},
     {0, 0}};
    g.loadGraph(graphtest); // Load the graph to the object.
    g.printGraph();         // Should print: "Graph with 5 vertices and 8 edges."
    cout << Algorithms::isConnected(g) << endl;        // Should print: "0" (false).
    ...
    vector<vector<int>> graphtest2 = {
       {0, 1, 0},
            {0, 0, 1},
            {0, 0, 0}};
                g.loadGraph(graphtest2); // Load the graph to the object.
    g.printGraph();         // Should print: "Graph with 5 vertices and 8 edges."
    cout << Algorithms::isConnected(g) << endl;        // Should print: "0" (false).
    ...
    // cout << Algorithms::negativeCycle(g) << endl;        // Should print: "The graph is bipartite: A={0, 2, 4}, B={1, 3}."
